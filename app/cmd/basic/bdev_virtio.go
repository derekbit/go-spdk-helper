...
func bdevVirtioAttachController(c *cli.Context) error {
	...
	bdevName, err := spdkCli.BdevVirtioAttachController(name, c.String("trtype"), c.String("traddr"), c.String("dev-type"))
	if err != nil {
		return err
	}
...
// func BdevVirtioGetCmd() cli.Command {
// 	return cli.Command{
// 		Name: "get",
// 		Flags: []cli.Flag{
// 			cli.Uint64Flag{
...
// 			},
// 		},
// 		Usage: "get all Virtio bdevs if a bdev name is not specified: \"get\", or \"get <Virtio BDEV NAME>\"",
// 		Action: func(c *cli.Context) {
// 			if err := bdevVirtioGet(c); err != nil {
// 				logrus.WithError(err).Fatalf("Failed to run get bdev virtio command")
// 			}
// 		},
// 	}
// }

// func bdevVirtioGet(c *cli.Context) error {
// 	spdkCli, err := client.NewClient(context.Background())
// 	if err != nil {
// 		return err
// 	}

// 	resp, err := spdkCli.BdevVirtioGet(c.Args().First(), 0)
// 	if err != nil {
// 		return err
// 	}
