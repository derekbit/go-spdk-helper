...
func (nsexec *Executor) prepareCommandArgs(envs []string, binary string, args []string) []string {
	cmdArgs := []string{}
...
func (nsexec *Executor) Execute(envs []string, binary string, args []string, timeout time.Duration) (string, error) {
	return nsexec.executor.Execute(nil, types.NsBinary, nsexec.prepareCommandArgs(envs, binary, args), timeout)
}
...
func (nsexec *Executor) ExecuteWithStdin(envs []string, binary string, args []string, stdinString string, timeout time.Duration) (string, error) {
	return nsexec.executor.ExecuteWithStdin(types.NsBinary, nsexec.prepareCommandArgs(envs, binary, args), stdinString, timeout)
}
...
func (nsexec *Executor) ExecuteWithStdinPipe(envs []string, binary string, args []string, stdinString string, timeout time.Duration) (string, error) {
	return nsexec.executor.ExecuteWithStdinPipe(types.NsBinary, nsexec.prepareCommandArgs(envs, binary, args), stdinString, timeout)
}
